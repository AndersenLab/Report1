...
yourFile<- "~/Dropbox/Coding/Active Projects/Report 2/testtrait.txt"

#Step 3 info goes below:
yourTrait<- "norm.brood"

source("~/Dropbox/Coding/Active Projects/Report 1/transformPhenotypesFunction.R")

#Step 4 info goes below:
pheno.df <- makePhenoDf(yourFile, yourTrait)
#This is a possible location where we could use Shiny to choose to display pheno.df if the user thinks there's something funky going on
plotTransformedPhenos(pheno.df)
```